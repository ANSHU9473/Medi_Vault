...
const features = [
    ...
    },
    {
        ...
        color: 'from-slate-700/80 to-blue-800/60',
    },
];
        ...
        <div className="min-h-screen bg-surface-950 overflow-hidden">
            ...
            <section className="relative z-10 max-w-7xl mx-auto px-6 pt-20 pb-32">
                ...
                >
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                        <Link
                            href="/auth/register"
                            className="group px-8 py-4 bg-primary-600 hover:bg-primary-500 text-white rounded-2xl font-semibold text-lg transition-all duration-200 flex items-center gap-2"
                        >
                            Start Free
            ...
            <section className="relative z-10 max-w-7xl mx-auto px-6 py-24 text-center">
                ...
                >
                    ...
                    <Link
                        href="/auth/register"
                        className="inline-flex items-center gap-2 px-10 py-5 bg-primary-600 hover:bg-primary-500 text-white rounded-2xl font-bold text-lg transition-all duration-200"
                    >
                        Create Free Account
